...
const Footer = () => {
    return (
        <>
        <div className='w-full h-auto px-5 lg:px-32 py-16 bg-[#f2f0ff] grid md:grid-cols-2 lg:grid-cols-5 gap-10'>
            <div className='flex flex-col gap-2 md:col-span-2'>
                ...
                <div className='grid grid-cols-6'>
                    ...
                    <button className='bg-[#fb2e86] text-white col-span-2 px-3 py-2 rounded-r-md'>Sign Up</button>
                </div>
