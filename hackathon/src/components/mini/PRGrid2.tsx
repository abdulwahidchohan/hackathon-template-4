...
const PRGrid2 = ({showDots=false}: {showDots?: boolean}) => {
  return (
        <>
        <div className='w-full h-[360px] flex flex-col relative group transition-all duration-200 hover:shadow-sm shadow-gray-300'>
            ...
            <div className='w-full h-[70%] bg-[#f6f7fb] flex justify-center items-center'>
                <Image src={'/grid2.png'} height={170} width={170} alt='product' />
            </div>

            {/* Details */}
            <div className='flex flex-col items-center justify-center gap-2 bg-white  py-2'>
                <h1 className='text-navyBlue font-lato font-semibold'>Luxury Sofa Chair</h1>
