...
const BlogCard2 = ({size = "MINI", content = ""}: {size?: "MINI" | "LARGE", content?:string}) => {
    return (
        <div className='w-full flex flex-col rounded-md group'>

            <Image src={"/blog1.jpg"} width={size == "MINI" ? 377 : 870} height={size == "MINI" ? 255 : 543} alt='blog' className={`rounded-md ${size == "MINI" ? 'h-1/2' : 'h-2/3'}  object-cover`} />
