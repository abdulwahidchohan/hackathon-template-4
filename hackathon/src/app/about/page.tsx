...
const AboutPage = () => {
    return (
        <div className='w-full'>
            ...
            <div className='w-full px-5 md:px-10 lg:px-40 pt-20 '>
                <div className='flex flex-col lg:flex-row justify-center items-center gap-5'>
                    ...
                    <div className='flex flex-col items-start justify-start w-full md:w-[550px] md:pl-10'>
                        <h1 className='font-bold text-3xl text-[#151875] py-3 font-josefin-sans'>Know about our Ecommerce Business History!</h1>
                        ...
                        <div className='flex justify-start items-center py-10'>
                            <button className='bg-[#fb2e86] rounded-sm font-josefin-sans px-8 text-white py-3'>Contact Us</button>
                        </div>
                    </div>
                </div>
            ...
            <div className='pt-20 px-5 lg:px-40 w-full bg-[#FBFBFF]'>
                ...
                <div className='flex-col flex justify-center items-center py-10'>
                    ...
                    <p className='font-bold font-lato text-center text-gray-400 w-full md:w-[690px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non duis ultrices quam vel dui sollicitudin aliquet id arcu. Nam vitae a enim nunc, sed sapien egestas ac nam. Tristique ultrices dolor aliquam lacus volutpat praesent.</p>
                </div>
