...
const FAQs = () => {
    return (
        <div className='w-full'>
            ...
            <div className='w-full px-5 md:px-12 lg:px-40 grid md:grid-cols-2 gap-10 my-20'>
                <div>
                ...
                <div className='flex flex-col justify-start items-start gap-4 bg-[#F8F8FD] p-2 lg:p-14'>
                    <h2 className={`py-2 text-2xl font-bold font-josefin-sans text-center text-[#151875]`}>
                        Ask a Question
                    </h2>
                    ...
                    <button className='bg-[#fb2e86] rounded-sm font-josefin-sans px-8 text-white py-3'>Send Message</button>
                </div>
            </div>
            <Companies />
        </div>
