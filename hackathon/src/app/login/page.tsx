  ...
  return (
    <div className='w-full'>
      ...
      <div className='flex justify-center items-center w-full'>
        <div className='flex flex-col shadow-2xl shadow-gray-100 border-2 border-gray-100 rounded-md p-10 md:w-[545px] my-28'>
            <div>
            ...
            <button className='bg-[#fb2e86] rounded-md font-josefin-sans px-8 text-white py-3 text-xl my-4'>Sign In</button>
